    ...
    let touzhu=[];
      if(md.type==="danshi"){
          ...
          touzhu=<LtP3P5NumList
              ...
              gamePrize={this.props.gamePrize}//拉杆赔率
              prize={game.toFixed(parseFloat(this.props.md.prize[1]*10000)*this.props.gamePrize*10000/(this.props.divisor*10000)/10000,3)}//赔率
              prize2={game.toFixed(parseFloat(this.props.md.prize[2]*10000)*this.props.gamePrize*10000/(this.props.divisor*10000)/10000,3)}//赔率
              divisor={this.props.divisor}
          />;
      }else{
          touzhu=<LtP3P5NumList
...
changePrize(prize,prize2){
      if(prize2){
          return " 一等奖 : "+prize+" 二等奖 : "+prize2
      }else{
          return prize
      }
}
      ...
      renderNumList.push(
        <div className="ch_chart" key={i}>
          <div className="ch_num_w">
            ...
            {this.props.gameKey==="g"||method_id!==260?<span>赔率:{(this.changePrize(this.props.prize,this.props.prize2))}</span>:""}
          </div>
          <div className="ch_num_box">
              ...
              {codeArr.map((num,j)=>{
                return(<li key={j}>
                  <button
                    ...
                    {this.props.gameKey==="x"&&method_id===260?<p className="underPrize">{(this.changePrize(this.props.prize,this.props.prize2))}</p>:""}
                </li>)
                })
              }
            </ul>
