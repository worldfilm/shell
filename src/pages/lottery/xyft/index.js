          ...
          renderNumList.push(
              <div className="ch_chart" key={i}>
                  <div className="ch_num_w">
                      ...
                      <span>赔率：{game.toFixed(parseFloat(this.props.gamePrize),3)}</span>
                  </div>
                  <div className="ch_num_box">
                        ...
                        <ul className="ch_num_show" style={{textAlign:"center"}} >
                            {codeArr.map((num,j)=>{
                                ...
                                return(<li key={j}>
                                    ...
                                    <label>{game.toFixed(parseFloat((this.props.gamePrize*10000*parseFloat(this.props.prize[level])))*10000/(this.props.divisor*10000)/10000,3)}</label>
                                </li>)
                            })
                            }
                        </ul>
